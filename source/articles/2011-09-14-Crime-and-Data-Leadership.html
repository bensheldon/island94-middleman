...
<blockquote><strong>Chicago to publish crime stats online</strong>
...
Ben Fry, <a href="http://flowingdata.com/2011/05/13/ben-fry-on-visualization-future-and-data-literacy/">on visualization future and data literacy</a> looks toward the future:
<blockquote>"I think the real thing that's going to change is that we're going to start understanding that visualization isn't this sort of monolithic thing... I like to look at it a lot like writing. You have novels and poetry and haikus. You know there's lots of different types of writing and styles of writing — and I think the same thing happens in visualization... some things are tools for analysis and some things are purely for entertainment, and there's not so much a spectrum that there is different ways of addressing it.</blockquote>
But this understanding and widespread "data literacy" is not here yet. Its up to us so called techie types to exhibit "Data Leadership" and work to better interpret the and explain the complexity and nuance of our analysis---the absence of which I've <a href="http://www.island94.org/2011/06/data-divides-and-umbrellafication/">complained about before</a>.

Data leadership is appropriately labeling data. Data leadership is presenting data with a recognition of its limitations. Data leadership is consideration for how your presentation of data may be interpreted <em>and responsibility</em> for the consequences.
...
<em>(Thanks <a href="http://justinmassa.com">Justin</a>, <a href="http://circuitous.org">Bec</a> and <a href="http://freegeekchicago.org/">David</a> for drawing my attention to this.)</em>
