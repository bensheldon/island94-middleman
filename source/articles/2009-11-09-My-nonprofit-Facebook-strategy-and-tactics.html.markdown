...
Googling around, I could only find technical advice ("install these apps") and crappy nonexistent-advice ("You need to have a strategy." <em>duh, tell me what that strategy would be</em>). So here's the stream of consciousness around what <em>I</em> do:
<ol>
