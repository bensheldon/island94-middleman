...
tags: []
wp:post_id: '3085'
link: http://island94.dev/2013/05/automatic-analysis/
wp:post_type: post
---

<a href="http://en.wikipedia.org/wiki/Karl_Fogel">Karl Fogel</a> on<a href="http://osrc.dfm.io/"> The Open Source Report Card</a>:
<blockquote>So, approximately every year or so, someone launches Yet Another Fully Automated Statistical Tool Dashboard Thing that tries to show the skills &amp; activity of a given open source contributor, or the "health" of a given open source project.
